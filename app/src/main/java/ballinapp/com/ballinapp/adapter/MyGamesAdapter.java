...
public class MyGamesAdapter extends RecyclerView.Adapter<MyGamesAdapter.MyGamesViewHolder> {
    ...
    public static class MyGamesViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MyGamesViewHolder(View v) {
            super(v);
    ...
    public MyGamesAdapter(List<Game> games, int rowLayout, Context context) {
        this.games = games;
    ...
    @Override
    public MyGamesAdapter.MyGamesViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
        return new MyGamesViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MyGamesViewHolder holder, final int position) {
    ...
    private void leaveGame(int gameId) {
        ...
        call.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                Toast.makeText(context, R.string.game_left, Toast.LENGTH_SHORT).show();
                swap(games);
            }
    ...
    private void swap(List<Game> datas) {
        games.clear();
        games.addAll(datas);
